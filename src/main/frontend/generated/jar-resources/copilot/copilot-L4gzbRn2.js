...
const un = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), he = "copilot-", zs = "24.5.15", Hc = "attention-required", Kc = "https://plugins.jetbrains.com/plugin/23758-vaadin", qc = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function Wc(e) {
...
function Tl() {
  Ee.push(import("./copilot-log-plugin-DsOeXk_2.js")), Ee.push(import("./copilot-info-plugin-CG_IWEn4.js")), Ee.push(import("./copilot-features-plugin-HbGkSLGc.js")), Ee.push(import("./copilot-feedback-plugin-CsTM8ZAL.js")), Ee.push(import("./copilot-shortcuts-plugin-UlGSSZAp.js"));
}
function kl() {
  {
...
let Jr = class extends Dl {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-D-fbiavh.js"), await import("./copilot-init-step2-4bqD2BLS.js"), Gs(), Tl(), this.tabIndex = 0, Tt.hostConnectedCallback(), window.addEventListener("keydown", Lr), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
